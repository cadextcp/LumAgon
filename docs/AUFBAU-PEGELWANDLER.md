...
**Zusätzlich nötig:** Lochraster 5×7 cm · Stiftleisten (2× 3-polig + 1× 2-polig,
aus einer langen Leiste abschneidbar) · Litze in den Netzfarben · optional eine
14-polige IC-Fassung (schont den IC). Die 12 V führen wir hier mit auf die
...
4. die Litzen nach Tabelle, kürzeste zuerst · 5. die 12-V-Leitung (lila) als
Letztes. Litzen vorher auf Länge schneiden und um die Löcher herum verlegen —
der Weg auf dem Bild ist der minimale.
